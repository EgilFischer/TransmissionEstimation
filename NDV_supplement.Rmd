...
- The challenge of the birds did not succeed, and these birds were actually susceptibles.

```{r include = F}
#Add 1 in group 1A and 2 in group 1B
out.nona.one.SIR.sensR <- out.nona.one.SIR
out.nona.one.SIR.sensR[out.nona.one.SIR.sensR$Group == "1A",]$N <- out.nona.one.SIR.sensR[out.nona.one.SIR.sensR$Group == "1A",]$N +1 
out.nona.one.SIR.sensR[out.nona.one.SIR.sensR$Group == "1B",]$N <- out.nona.one.SIR.sensR[out.nona.one.SIR.sensR$Group == "1B",]$N +2
...
#Add 1 in group 1A and 2 in group 1B
out.nona.one.SIR.sensS <- out.nona.one.SIR
out.nona.one.SIR.sensS[out.nona.one.SIR.sensS$Group == "1A",]$N <- out.nona.one.SIR.sensS[out.nona.one.SIR.sensS$Group == "1A",]$N +1 
out.nona.one.SIR.sensS[out.nona.one.SIR.sensS$Group == "1B",]$N <- out.nona.one.SIR.sensS[out.nona.one.SIR.sensS$Group == "1B",]$N +2
out.nona.one.SIR.sensS[out.nona.one.SIR.sensS$Group == "1A",]$S <- out.nona.one.SIR.sensS[out.nona.one.SIR.sensS$Group == "1A",]$S +1 
out.nona.one.SIR.sensS[out.nona.one.SIR.sensS$Group == "1B",]$S <- out.nona.one.SIR.sensS[out.nona.one.SIR.sensS$Group == "1B",]$S +2

fit.SIR.sensS <- glm(cbind(C, S-C) ~ relevel(Vaccinated,ref = "No") ,
                offset = log(I/N),
                family = binomial(link = "cloglog"), data = out.nona.one.SIR.sensS, 
                na.action = na.omit)

#beta and R0
mean.logbeta.sensS <- cumsum(summary(fit.SIR.sensS)$coefficients[,1])
var.logbeta.sensS <- summary(fit.SIR.sensS)$coefficients[,2]^2
confint.logbeta.sensS<-  confint(fit.SIR.sensS)+c(0,mean.logbeta.sensS[1])

#calculate R
mean.logR.sensS <- mean.logbeta.sensS + mean.log.inf.per
var.logR.sensS <- var.logbeta.sensS + var.log.inf.per
cll.logR.sensS <- mean.logR.sensS - qnorm(1-0.05/2) * sqrt(var.logR.sensS)
cul.logR.sensS <- mean.logR.sensS + qnorm(1-0.05/2) * sqrt(var.logR.sensS)
...
exp(mean.logbeta.sensS)
exp(confint.logbeta.sensS)

exp(mean.logR.sensS)
exp(c(cll.logR.sensS , cul.logR.sensS))
```
