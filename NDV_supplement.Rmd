...
```{r include = F}
#subtract 1 in group 1A and 3 in group 1B from susceptible to assume these birds are not-susceptible, but do add to the total population size
...
out.nona.one.SIR.sensS[out.nona.one.SIR.sensS$Group == "1B",]$N <- out.nona.one.SIR.sensS[out.nona.one.SIR.sensS$Group == "1B",]$N -3
out.nona.one.SIR.sensS[out.nona.one.SIR.sensS$Group == "1A",]$S <- out.nona.one.SIR.sensS[out.nona.one.SIR.sensS$Group == "1A",]$S -1 
out.nona.one.SIR.sensS[out.nona.one.SIR.sensS$Group == "1B",]$S <- out.nona.one.SIR.sensS[out.nona.one.SIR.sensS$Group == "1B",]$S -3
